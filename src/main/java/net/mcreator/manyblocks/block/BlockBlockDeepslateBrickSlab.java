...
public class BlockBlockDeepslateBrickSlab extends ElementsManyblocksMod.ModElement {
	@GameRegistry.ObjectHolder("manyblocks:block_deepslate_brick_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("manyblocks:block_deepslate_brick_slab_double")
	public static final Block block_slab_double = null;
	public BlockBlockDeepslateBrickSlab(ElementsManyblocksMod instance) {
		super(instance, 81);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("block_deepslate_brick_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("block_deepslate_brick_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("manyblocks:block_deepslate_brick_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("block_deepslate_brick_slab");
