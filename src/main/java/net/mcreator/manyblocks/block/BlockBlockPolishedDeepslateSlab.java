...
public class BlockBlockPolishedDeepslateSlab extends ElementsManyblocksMod.ModElement {
	@GameRegistry.ObjectHolder("manyblocks:block_polished_deepslate_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("manyblocks:block_polished_deepslate_slab_double")
	public static final Block block_slab_double = null;
	public BlockBlockPolishedDeepslateSlab(ElementsManyblocksMod instance) {
		super(instance, 79);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("block_polished_deepslate_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("block_polished_deepslate_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("manyblocks:block_polished_deepslate_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("block_polished_deepslate_slab");
