...
public class BlockBlockBlockOfStrippedBamboo extends ElementsManyblocksMod.ModElement {
	@GameRegistry.ObjectHolder("manyblocks:block_block_of_stripped_bamboo")
	public static final Block block = null;
	public BlockBlockBlockOfStrippedBamboo(ElementsManyblocksMod instance) {
		super(instance, 46);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("block_block_of_stripped_bamboo"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("manyblocks:block_block_of_stripped_bamboo", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("block_block_of_stripped_bamboo");
